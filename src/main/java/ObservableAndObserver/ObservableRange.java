 ...
 */
/*Range
This operator creates an ObservableAndObserver that emits a range of sequential integers. The function takes two arguments: the starting number and length.

Sample Implementation: The below sample creates an ObservableAndObserver using ObservableAndObserver.range() method.
